...
class Artifact(models.Model):
    ...
    class Meta:
        ...
        unique_together = (('artifact_role_id', 'artifact_sub_module_id'),)
        indexes = [
            models.Index(fields=['artifact_role_id']),
            models.Index(fields=['artifact_sub_module_id']),
...
class SubModule(models.Model):
    ...
    sub_module_link = models.CharField(max_length=250, unique=True)
    sub_module_module_id = models.ForeignKey('Module', on_delete=models.SET_NULL, null=True, db_column='sub_module_module_id')
    sub_module_status = models.CharField(max_length=1, choices=SUB_MODULE_STATUS_CHOICES, default='Y')
    updated_at = models.DateTimeField(auto_now=True)
