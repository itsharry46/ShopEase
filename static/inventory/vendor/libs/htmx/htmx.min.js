var htmx = (function () {
  ...
  function Gt(o) {
    ...
    e.onload = function () {
      if (this.status >= 200 && this.status < 400) {
        ...
        Kt(r.tasks);
        Bt = o;
        de(ne().body, "htmx:historyRestore", { path: o, cacheMiss: true, serverResponse: this.response });
      } else {
    ...
    se(["loadstart", "loadend", "progress", "abort"], function (t) {
      se([p, p.upload], function (e) {
        e.addEventListener(t, function (e) {
          de(r, "htmx:xhr:" + t, { lengthComputable: e.lengthComputable, loaded: e.loaded, total: e.total });
        });
      });
    });
  ...
  function Dn(o, i) {
    ...
    var p = s.response;
    var m = ce({ shouldSwap: a, serverResponse: p, isError: f, ignoreTitle: d, selectOverride: h, swapOverride: g }, i);
