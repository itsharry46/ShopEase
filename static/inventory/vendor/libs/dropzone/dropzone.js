                      ...
                      var r = n(9974),
                        ...
                        l = function (e) {
                          ...
                          return function (d, v, y, g) {
                            for (
                              var m, b, x = o(d), w = i(x), E = r(v, y, 3), k = a(w.length), A = 0, S = g || u, F = t ? S(d, k) : n || p ? S(d, 0) : void 0;
                              k > A;
                              A++
                            )
                    ...
                    2109: function (e, t, n) {
                      ...
                      e.exports = function (e, t) {
                        ...
                        if ((n = v ? r : y ? r[d] || u(d, {}) : (r[d] || {}).prototype))
                          for (c in t) {
                            if (
                              ((p = t[c]), (f = e.noTargetGet ? (h = i(n, c)) && h.value : n[c]), !l(v ? c : d + (y ? "." : "#") + c, e.forced) && void 0 !== f)
                            ) {
                        ...
                        },
                        {
                          splice: function (e, t) {
                            var n,
                              ...
                              b = arguments.length;
                            if (
                              (0 === b ? (n = r = 0) : 1 === b ? ((n = 0), (r = g - m)) : ((n = b - 2), (r = p(f(o(t), 0), g - m))),
                  ...
                  (function () {
                    ...
                    var u = {
                      ...
                      fallback: function () {
                        ...
                        var t,
                          n = o(this.element.getElementsByTagName("div"), !0);
                        try {
                          for (n.s(); !(t = n.n()).done; ) {
                            var r = t.value;
                      ...
                      addedfile: function (e) {
                        ...
                        if (
                          ...
                          var n,
                            r = o(e.previewElement.querySelectorAll("[data-dz-name]"), !0);
                          try {
                            for (r.s(); !(n = r.n()).done; ) {
                              var i = n.value;
                          ...
                          var a,
                            u = o(e.previewElement.querySelectorAll("[data-dz-size]"), !0);
                          try {
                          ...
                          var s,
                            l = function (n) {
                              return (
                                n.preventDefault(),
                                n.stopPropagation(),
                                e.status === m.UPLOADING
                                  ? m.confirm(t.options.dictCancelUploadConfirmation, function () {
                                      return t.removeFile(e);
                                    })
                                  : t.options.dictRemoveFileConfirmation
                                  ? m.confirm(t.options.dictRemoveFileConfirmation, function () {
                                      return t.removeFile(e);
                                    })
                                  : t.removeFile(e)
                              );
                      ...
                      thumbnail: function (e, t) {
                        if (e.previewElement) {
                          ...
                          var n,
                            r = o(e.previewElement.querySelectorAll("[data-dz-thumbnail]"), !0);
                          try {
                            for (r.s(); !(n = r.n()).done; ) {
                              var i = n.value;
                      ...
                      error: function (e, t) {
                        if (e.previewElement) {
                          ...
                          var n,
                            r = o(e.previewElement.querySelectorAll("[data-dz-errormessage]"), !0);
                          try {
                      ...
                      uploadprogress: function (e, t, n) {
                        if (e.previewElement) {
                          var r,
                            i = o(e.previewElement.querySelectorAll("[data-dz-uploadprogress]"), !0);
                          try {
                            for (i.s(); !(r = i.n()).done; ) {
                              var a = r.value;
                    ...
                    var m = (function (e) {
                      ...
                      function o(e, t) {
                        ...
                        if (
                          ((n.options = o.extend({}, u, s, null != t ? t : {})),
                                  ...
                                  this.clickableElements.forEach(function (t) {
                                    return e.listeners.push({
                                      ...
                                      events: {
                                        click: function (n) {
                                          return (
                                            (t !== e.element || n.target === e.element || o.elementInside(n.target, e.element.querySelector(".dz-message"))) &&
                              ...
                              value: function (e) {
                                ...
                                this._transformFiles(e, function (n) {
                                  ...
                                  if (e[0].upload.chunked) {
                                    ...
                                    if (
                                      ((i.upload.finishedChunkUpload = function (n, r) {
                                        var a = !0;
                            ...
                            },
                            {
                              ...
                              value: function (e) {
                                if ("FORM" === this.element.tagName) {
                                  var t,
                                    n = l(this.element.querySelectorAll("input, textarea, select, button"), !0);
                                  try {
                                    for (n.s(); !(t = n.n()).done; ) {
                                      var r = t.value,
                    ...
                    (m.createElement = function (e) {
                      ...
                      (m.getElements = function (e, t) {
                        ...
                        if (e instanceof Array) {
                          ...
                          r = [];
                          var a,
                            u = l(document.querySelectorAll(e), !0);
                          try {
                  ...
                  (function (e, r, i) {
                    return function () {
                      (e.upload = {
                        ...
                        100 === e.upload.progress && ((e.status = t().SUCCESS), n.emit("success", e, "success", null), n.emit("complete", e), n.processQueue());
                    };
                  })(i, o, a),
                  u
                );
