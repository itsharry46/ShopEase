                      ...
                      return (
                        ...
                        function () {
                          var a = new Date(),
                            c = e - (a - o);
                          return (
                            (n = this), (i = arguments), c <= 0 ? (clearTimeout(r), (r = null), (o = a), (s = t.apply(n, i))) : r || (r = setTimeout(u, c)), s
                          );
                        }
                      );
                    },
                ...
                (u = (function () {
                  ...
                  return (
                    n.mixin(i.prototype, {
                      ...
                      set: function (t, e, i) {
                        return (
                          n.isNumber(i) ? this._safeSet(this._ttlKey(t), s(r() + i)) : this.ls.removeItem(this._ttlKey(t)), this._safeSet(this._prefix(t), s(e))
                        );
                      },
                      remove: function (t) {
                  ...
                  return {
                    ...
                    trigger: function (n) {
                      ...
                      for (n = n.split(t), o = [].slice.call(arguments, 1); (r = n.shift()) && (s = this._callbacks[r]); )
                        (u = i(s.sync, this, [r].concat(o))), (a = i(s.async, this, [r].concat(o))), u() && e(a);
                      return this;
                    },
                  };
                  function n(e, n, i, r) {
                    ...
                    n.mixin(i.prototype, s, {
                      ...
                      isCursorAtEnd: function () {
                        ...
                        return (
                          ...
                          n.isNumber(e)
                            ? e === t
                            : !document.selection || ((i = document.selection.createRange()).moveStart("character", -t), t === i.text.length)
                        );
                      },
                      destroy: function () {
                        this.$hint.off(".tt"),
                        ...
                        this.cancel(),
                          ...
                          this.source(t, o, function (r) {
                            (r = r || []),
                              !i &&
                                s < n.limit &&
                                ((n.cancel = e.noop), (s += r.length), n._append(t, r.slice(0, n.limit - s)), n.async && n.trigger("asyncReceived", t));
                          }),
                          !r && o([]);
                      },
                      cancel: e.noop,
                  ...
                  return (
                    n.mixin(t.prototype, {
                      ...
                      activate: function () {
                        return (
                          !!this.isActive() ||
                          (!(!this.isEnabled() || this.eventBus.before("active")) && ((this.active = !0), this.eventBus.trigger("active"), !0))
                        );
                      },
                      deactivate: function () {
                      ...
                      open: function () {
                        return (
                          this.isOpen() || this.eventBus.before("open") || (this.menu.open(), this._updateHint(), this.eventBus.trigger("open")), this.isOpen()
                        );
                      },
                      close: function () {
                        return (
                      ...
                      select: function (t) {
                        ...
                        return !(
                          ...
                          (this.input.setQuery(e.val, !0), this.eventBus.trigger("select", e.obj), this.close(), 0)
                        );
                      },
                      ...
                      moveCursor: function (t) {
                        ...
                        return (
                          ...
                          !(
                            ...
                            i ? this.input.setInputValue(i.val) : (this.input.resetInputValue(), this._updateHint()),
