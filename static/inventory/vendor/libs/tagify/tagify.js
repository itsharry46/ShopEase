          ...
          t.exports = (function () {
            ...
            var O = {
              ...
              render() {
                var t,
                  ...
                  i =
                    ...
                    t),
                  s = this.settings;
                return "number" == typeof s.dropdown.enabled && s.dropdown.enabled >= 0
              ...
              events: {
                binding() {
                  ...
                  "manual" != this.settings.dropdown.position &&
                    (document[s]("scroll", i.position, !0), window[s]("resize", i.position), window[s]("keydown", i.onKeyDown)),
                              ...
                              t.preventDefault(),
                                e.hooks
                                  ...
                                  .then(() => {
                                    if (i)
                                      return (
                                        this.dropdown.selectOption(i), (i = this.dropdown.getNextOrPrevOption(i, !r)), void this.dropdown.highlightOption(i)
                                      );
              ...
              filterListItems(t, e) {
                ...
                if (!(t = "select" == r.mode && this.value.length && this.value[0][r.tagTextProp] == t ? "" : t) || !m.length)
                  return (
                    (d = l.includeSelectedTags ? p : p.filter((t) => !this.isTagDuplicate(h(t) ? t.value : t))),
              ...
              createListHTML(t) {
                return g([], t)
                  .map((t, i) => {
                    ...
                    return (
                      (s = "string" == typeof s && this.settings.dropdown.escapeHTML ? d(s) : s),
            ...
            var M,
              ...
              _ = {
                ...
                dropdown(t) {
                  var e = t.dropdown;
                  return `<div class="${"manual" == e.position ? "" : t.classNames.dropdown} ${e.classname}" role="listbox" aria-labelledby="dropdown" dir="${
                    e.RTL ? "rtl" : ""
                  ...
                  onFocusBlur(t) {
                    ...
                    if (!r && !l)
                      if (((this.state.hasFocus = "focus" == a && +new Date()), this.toggleFocusClass(this.state.hasFocus), "mix" != e.mode)) {
                        if ("focus" == a)
                          return (
                            this.trigger("focus", o), void ((0 !== e.dropdown.enabled && e.userInput) || this.dropdown.show(this.value.length ? "" : void 0))
                          );
                        "blur" == a &&
                          (this.trigger("blur", o),
                          this.loading(!1),
                          "select" == e.mode && (d && (this.removeTags(), (i = "")), s === i && (i = "")),
                        ...
                        "focus" == a
                          ...
                          : "blur" == t.type &&
                            (this.trigger("blur", o), this.loading(!1), this.dropdown.hide(), (this.state.dropdown.visible = void 0), this.setStateSelection());
                  },
                              ...
                              switch (t.key) {
                                ...
                                case "Backspace":
                                  ...
                                  if ("edit" == e.backspace && d)
                                    return (
                                      (h = 1 == a.anchorNode.nodeType ? null : a.anchorNode.previousElementSibling),
                                  ...
                                  if (
                                    ((n || d) && 1 == a.anchorNode.nodeType
                                      ? (g = 0 == a.anchorOffset ? (n ? c[0] : null) : c[Math.min(c.length, a.anchorOffset) - 1])
                                      : n
                                      ? (g = a.anchorNode.nextElementSibling)
                                      : d instanceof Element && (g = d),
                    ...
                    if (window.getSelection && (o = window.getSelection()).rangeCount > 0 && 3 == o.anchorNode.nodeType) {
                      if (
                        ...
                        if (
                          ...
                          return (
                            (this.state.tag.value = this.state.tag.value.replace(d.delimiters, "")),
                        ...
                        try {
                          (r =
                            (r = this.state.flaggedTags[this.state.tag.baseOffset]).prefix == this.state.tag.prefix && r.value[0] == this.state.tag.value[0]),
                          ...
                          void 0 === e && (e = i),
                            e &&
                              ...
                              "mix" == this.settings.mode
                                ...
                                : ((this.state.inputText = e), this.dropdown.show(e)));
                        })
                        .catch((t) => t));
                  },
                  onDrop(t) {
                    ...
                    t.forEach((t) => {
                      t.addedNodes.forEach((t) => {
                        if ("<div><br></div>" == t.outerHTML) t.replaceWith(document.createElement("br"));
                          ...
                          if (
                            (3 != t.previousSibling?.nodeType || t.previousSibling.textContent || t.previousSibling.remove(),
              ...
              (S.prototype = {
                ...
                applySettings(t, i) {
                  ...
                  if (
                    ...
                    "autoComplete" in i && !h(i.autoComplete) && ((a.autoComplete = y.autoComplete), (a.autoComplete.enabled = i.autoComplete)),
                    "mix" == a.mode &&
                      ((a.pattern = a.pattern || /@/),
                ...
                loadOriginalValues(t) {
                  ...
                  if ((this.removeAllTags(), t))
                    if ("mix" == i.mode)
                      this.parseMixTags(t), ((e = this.DOM.input.lastChild) && "BR" == e.tagName) || this.DOM.input.insertAdjacentHTML("beforeend", "<br>");
                    else {
                      try {
                ...
                onEditTagDone(t, e) {
                  ...
                  this.trigger("edit:beforeUpdate", s, {
                    ...
                    t && ((i = e[a.tagTextProp]) ? i.trim() && i : a.tagTextProp in e ? void 0 : e.value)
                      ? ((t = this.replaceTag(t, e)), this.editTagToggleValidity(t, e), a.a11y.focusableTags ? t.focus() : w(t))
                      : t && this.removeTags(t),
                ...
                replaceTextWithNode(t, e) {
                  if (this.state.tag || e) {
                    ...
                    return (
                      ...
                      -1 == (i = n.nodeValue.lastIndexOf(e)) || ((s = n.splitText(i)), t && n.parentNode.replaceChild(t, s)),
                      !0
                    );
                  }
                },
                ...
                addTags(t, e, i) {
                  ...
                  return (
                    ...
                    t.forEach((t) => {
                      ...
                      if (
                        ((t = Object.assign({}, l)), a.transformTag.call(this, t), (t.__isValid = this.hasMaxTags() || this.validateTag(t)), !0 !== t.__isValid)
                      ) {
                        if (i) return;
                        if (
                      ...
                      if (
                        ("readonly" in t && (t.readonly ? (r["aria-readonly"] = !0) : delete t.readonly),
