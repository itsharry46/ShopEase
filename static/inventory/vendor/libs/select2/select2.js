                    ...
                    n.define("select2/utils", ["jquery"], function (e) {
                      ...
                      (i.prototype.on = function (e, t) {
                        ...
                        (t.hasScroll = function (t, n) {
                          ...
                          return (
                            ...
                            ("scroll" === r || "scroll" === o || i.innerHeight() < n.scrollHeight || i.innerWidth() < n.scrollWidth)
                          );
                        }),
                      ...
                      return (
                        (t.GetUniqueElementId = function (e) {
                          ...
                          return (
                            null == t &&
                              (e.id ? ((t = e.id), e.setAttribute("data-select2-id", t)) : (e.setAttribute("data-select2-id", ++r), (t = r.toString()))),
                            t
                          );
                        }),
                                ...
                                try {
                                  ...
                                  try {
                                    ...
                                    n &&
                                      ...
                                      console.warn &&
                                      console.warn(
                                        'Select2: The language file for "' + s + '" could not be automatically loaded. A fallback will be used instead.'
                                      );
                                  }
                                }
                      ...
                      return (
                        (n.prototype.current = function (t, n) {
                          function i(t, n) {
                            var r = [];
                            return (
                              t.selected || -1 !== e.inArray(t.id, n) ? ((t.selected = !0), r.push(t)) : (t.selected = !1),
