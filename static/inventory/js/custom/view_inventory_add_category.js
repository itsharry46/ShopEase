...
//     a = (
//       isDarkStyle
//         ? ((e = config.colors_dark.borderColor), (t = config.colors_dark.bodyBg), config.colors_dark)
//         : ((e = config.colors.borderColor), (t = config.colors.bodyBg), config.colors)
//     ).headingColor;
...
//                   (n
//                     ? '<img src="' + assetsPath + "img/ecommerce-images/" + n + '" alt="Product-' + l + '" class="rounded">'
//                     : '<span class="avatar-initial rounded-2 bg-label-' +
//                       ["success", "danger", "warning", "info", "dark", "primary", "secondary"][Math.floor(6 * Math.random())] +
//                       '">' +
//                       (n = (((n = (s = a.category_detail).match(/\b\w/g) || []).shift() || "") + (n.pop() || "")).toUpperCase()) +
//                       "</span>") +
